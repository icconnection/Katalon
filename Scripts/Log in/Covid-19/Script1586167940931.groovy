...
//WebUI.setText(findTestObject('Object Repository/Covid-19 Object Repo/Page_Coronavirus Update (Live) 1204075 Case_106633/input_Search_form-control input-sm'), Country)

for(def rowNum=1; rowNum <=findTestData ("Covid-19/Country").getRowNumbers(); rowNum++) 
{
WebUI.setText(findTestObject('Object Repository/Covid-19 Object Repo/Page_Coronavirus Update (Live) 1204075 Case_106633/input_Search_form-control input-sm'), 
    findTestData('Covid-19/Country').getValue(1, rowNum))
